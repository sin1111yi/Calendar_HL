package com.example.handlelife.index;
...
public class IndexActivity extends BaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, com.example.handlelife.index.IndexActivity.class));
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_colorful:
                ...
                break;
            case R.id.ll_index:
                com.example.handlelife.index.IndexActivity.show(this);
                break;
        }
    }
